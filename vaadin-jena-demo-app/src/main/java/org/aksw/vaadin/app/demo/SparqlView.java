...
public class SparqlView extends VerticalLayout implements BeforeEnterObserver {
...
//    protected TileLayer darkLayer = new TileLayer("http://{s}.basemaps.cartocdn.com/rastertiles/dark_all/{z}/{x}/{y}.png");
    ...
    @Autowired
    public SparqlView(QueryExecutionFactoryQuery qef) throws InterruptedException, ExecutionException {
        this.qef = qef;
...
//        resultSetGrid.setDataProvider(dataProvider);
    }
